...
### 메인 페이지
 - **부동산 검색 및 연관검색어 결과**
   - 타이핑 이벤트 발생시 서버에 건물 데이터를 요청하고, 받아온 데이터를 바탕으로 연관검색어 결과를 나타냈습니다.
   - 검색 단어와 연관검색어가 일치하는 부분은 강조처리 하고, 결과 클릭시 해당 건물의 정보 페이지로 Navigate 합니다.
